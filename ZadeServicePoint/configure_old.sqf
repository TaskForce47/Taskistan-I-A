...
//ANTITANK
_Weapon = [["tf47_m3maaws",1],["tf47_at4_heat",4],["rhs_weap_fgm148",1]];
_Magazin = [["tf47_m3maaws_heat",2],["tf47_m3maaws_he",3],["tf47_m3maaws_hedp",2],["tf47_m3maaws_smoke",4],["tf47_m3maaws_illum",2],["rhs_fgm148_magazine_AT",2]];
...
_Magazin = [["DemoCharge_Remote_Mag",10],["SatchelCharge_Remote_Mag",2],["rhs_mag_m18_red",1],["rhs_mag_m18_green",1],["rhs_mag_m18_yellow",1],["rhs_mag_an_m8hc",5]];
_Item = [["ACE_Clacker",2],["ACE_DefusalKit",4]];
_Backpacks = [];
_EOD = [true,"EOD",90,_Weapon,_Magazin,_Item,_Backpack];
 
//INFANTRY
_Weapon = [["rhs_weap_m4a1_carryhandle",4],["tf47_at4_heat",2]];
...
_Item = [["ACE_fieldDressing",40],["ACE_packingBandage",40],["ACE_elasticBandage",40],["ACE_quikclot",40],["ACE_tourniquet",16],["ACE_atropine",16],["ACE_morphine",30],["ACE_epinephrine",36],["ACE_plasmaIV",16],["ACE_salineIV",10],["ACE_bloodIV",6],["ACE_personalAidKit",5],["ACE_surgicalKit",10]];
_Backpack = [];
_MEDICAL = [true,"MEDICAL",90,[],_Magazin,_Item,[]];
 
//AA_MODULE
_Weapon = [["rhs_weap_fim92",1]];
_Magazin = [["rhs_fim92_mag",2]];
_Item = [];
_Backpack = [];
_AA_MODULE = [false,"AA Modul",45,_Weapon,_Magazin,[],[]];
 
//AMMUNITION_MODULE
_Weapon = [];
_Magazin = [["rhs_mag_30Rnd_556x45_Mk318_Stanag",30],["hlc_200rnd_556x45_M_SAW",10],["rhsusf_100Rnd_762x51",5],["rhs_mag_m67",5]];
_Item = [];
_Backpack = [];
_AMMUNITION_MODULE = [false,"AMMUNITION Modul",45,[],_Magazin,[],[]];
 
//ANTITANK_MODULE
_Weapon = [["tf47_m3maaws",1]];
_Magazin = [["tf47_m3maaws_heat",2],["tf47_m3maaws_he",2],["tf47_m3maaws_smoke",1]];
_Item = [["tf47_optic_m3maaws",1]];
_Backpack = [];
_ANTITANK_MODULE = [false,"ANTITANK Modul",45,_weapon,_magazin,_item,[]];
...
_Weapon = [];
_Magazin = [];
_Item = [["ACE_fieldDressing",10],["ACE_packingBandage",10],["ACE_elasticBandage",10],["ACE_quikclot",10],["ACE_tourniquet",4],["ACE_atropine",4],["ACE_morphine",10],["ACE_epinephrine",10],["ACE_plasmaIV",4],["ACE_salineIV",10],["ACE_bloodIV",4],["ACE_personalAidKit",2],["ACE_surgicalKit",2]];
_Backapck = [];
_MEDICAL_MODULE = [false,"MEDICAL Modul",45,[],[],_Item,[]];
...
_UAV_MODULE = [false,"UAV Modul",45,[],[],_Items,_Backpack];
...
ZadeServicePoint_Loadouts = [_ANTITANK,_EOD,_INFANTRY,_MEDICAL,_AA_MODULE,_AMMUNITION_MODULE,_ANTITANK_MODULE,_COMMAND_MODULE,_MEDICAL_MODULE,_UAV_MODULE];
