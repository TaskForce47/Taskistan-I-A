...
sideObj = ObjNull;
sideMissionUp = false;
//_null = [] execVM "mission\side\aw_functions.sqf";	//AW INIT
//_null = [] execVM "scripts\misc\airbaseDefense.sqf";													// Airbase air defense												// clear bodies around island
_null = [] execVM "scripts\misc\islandConfig.sqf";														// prep the island for mission
_null = [] execVM "scripts\misc\cleanup.sqf";
// _null = [] execVM "scripts\tf47\randomAA.sqf";