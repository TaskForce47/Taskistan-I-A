...
#define OBJVEH_TYPES "rhsgref_ins_g_uaz","rhsgref_ins_g_gaz66","rhsgref_ins_g_uaz","rhsgref_ins_g_gaz66","rhsgref_ins_g_ural_open","rhsgref_ins_g_ural_work_open"
#define OBJUNIT_TYPES "rhsgref_ins_g_commander"
...
//-------------------------------------------------------------------------- CREATE GROUP, VEHICLE AND UNIT
	...
	"rhsgref_ins_g_squadleader" createUnit [_flatPos1, _aGroup];
	...
	"rhsgref_ins_g_squadleader" createUnit [_flatPos1, _bGroup];
	...
	"rhsgref_ins_g_squadleader" createUnit [_flatPos2, _cGroup];
