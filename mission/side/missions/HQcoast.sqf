...
//------------------------------------------- SPAWN OBJECTIVE AND AMBIENCE 
	...
	boat setDir random 360;
		"rhsgref_ins_g_rifleman" createUnit [_boatPos,_smuggleGroup]; "rhsgref_ins_g_rifleman" createUnit [_boatPos,_smuggleGroup]; "rhsgref_ins_g_rifleman" createUnit [_boatPos,_smuggleGroup]; "rhsgref_ins_g_rifleman" createUnit [_boatPos,_smuggleGroup]; "rhsgref_ins_g_rifleman" createUnit [_boatPos,_smuggleGroup];
